...
func InitSql() {
	...
	// 初始化
	Db.Exec("insert into admin_user (id, user_name, password, real_name, tel, status) values (1, 'admin', '$2a$10$057uuCLoKja2J04GLuWl1eNnwQtS7HxvookpbBa0thTHq7/fIaNF6', 'leo', '13166668888', 1)")

	Db.Exec("insert into role (id, pid, name, auth) values (1, 0, '超级管理员', '11,1100,1101,1102,110000,110001,110002,110003,110004,110005,110100,110101,110102,110103,110104,110105,110200,110201')")
	...
	Db.Exec("insert into casbin_rule (p_type, v0, v1, v2) values ('p', 'role:1', '/auth', 'get')")
	Db.Exec("insert into casbin_rule (p_type, v0, v1, v2) values ('p', 'role:1', '/auth/treemenu', 'get')")
	...
	Db.Exec("INSERT INTO auth (id, pid, name, is_menu, api, action, ext) VALUES (1102, 11, '权限', 1, '', '', 'admin-auth');")
	...
	Db.Exec("INSERT INTO auth (id, pid, name, is_menu, api, action, ext) VALUES (110200, 1102, '获取树形菜单', 0, '/auth/treemenu', 'get', 'admin-auth-tree');")
	Db.Exec("INSERT INTO auth (id, pid, name, is_menu, api, action, ext) VALUES (110201, 1102, '权限列表', 0, '/auth', 'get', 'admin-auth-list');")
}
